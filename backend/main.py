...
async def startup_event():
    ...
    try:
        ...
        async with _Session() as s:
            ...
            await s.execute(_text("ALTER TABLE programs ADD COLUMN IF NOT EXISTS pricing_info TEXT"))
            await s.execute(_text("ALTER TABLE programs ADD COLUMN IF NOT EXISTS image_url TEXT"))
            await s.execute(_text("ALTER TABLE programs ADD COLUMN IF NOT EXISTS booking_opens_at TIMESTAMPTZ"))
            await s.execute(_text("ALTER TABLE programs ADD COLUMN IF NOT EXISTS allow_parallel BOOLEAN DEFAULT FALSE"))
            await s.execute(_text("ALTER TABLE programs ADD COLUMN IF NOT EXISTS max_concurrent_bookings INTEGER DEFAULT 1"))
            await s.execute(_text("ALTER TABLE programs ALTER COLUMN max_concurrent_bookings SET DEFAULT 1"))
            await s.execute(_text("ALTER TABLE programs ALTER COLUMN max_concurrent_bookings DROP NOT NULL"))
            await s.execute(_text("ALTER TABLE programs ADD COLUMN IF NOT EXISTS collision_resources JSON DEFAULT '[]'::json"))
            await s.execute(_text("ALTER TABLE programs ADD COLUMN IF NOT EXISTS collision_lecturer_ids JSON DEFAULT '[]'::json"))
            await s.execute(_text("ALTER TABLE programs ADD COLUMN IF NOT EXISTS blocked_program_ids JSON DEFAULT '[]'::json"))
            await s.execute(_text("ALTER TABLE programs ADD COLUMN IF NOT EXISTS required_lecturers INTEGER NOT NULL DEFAULT 1"))
            await s.execute(_text("ALTER TABLE programs ADD COLUMN IF NOT EXISTS room_id UUID"))
            await s.execute(_text("ALTER TABLE programs ADD COLUMN IF NOT EXISTS feedback_enabled BOOLEAN DEFAULT TRUE"))
            await s.execute(_text("ALTER TABLE programs ADD COLUMN IF NOT EXISTS feedback_questions JSON DEFAULT '[]'::json"))
