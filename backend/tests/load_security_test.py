...
API_URL = sys.argv[1] if len(sys.argv) > 1 else "https://audit-enhance-fix.preview.emergentagent.com"
API = f"{API_URL}/api"
...
async def main():
    API_URL_VAL = sys.argv[1] if len(sys.argv) > 1 else "https://audit-enhance-fix.preview.emergentagent.com"
