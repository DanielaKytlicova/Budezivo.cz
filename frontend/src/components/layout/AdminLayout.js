...
export const AdminLayout = ({ children }) => {
  ...
  const getNavItems = () => {
    const baseItems = [
      ...
      // ── Lower zone (flat) ──
      { path: '/admin/lecturer-profile', icon: GraduationCap, label: 'Dostupnost', testId: 'nav-lecturer-profile', roles: ['admin', 'spravce', 'edukator', 'lektor', 'produkcni', 'staff', 'viewer'] },
