...
4. Authorized JavaScript origins:
   - `https://budezivo.cz`
   - `https://audit-backend-fixes.preview.emergentagent.com` (preview env, optional)
5. Authorized redirect URIs:
   - `https://budezivo.cz/api/google-calendar/callback`
   - `https://audit-backend-fixes.preview.emergentagent.com/api/google-calendar/callback`
